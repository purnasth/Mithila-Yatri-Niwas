    ...
    <>
      ...
      >
        <div
          ...
          className={`absolute bottom-0 h-full w-full bg-[url('/src/assets/janakiSketch.png')] bg-contain bg-bottom bg-repeat-x bg-fixed z-0`}
        />
        {/* <div className="absolute bg-black/40 inset-0 z-0" /> */}
        <section className="z-10 text-custom-white">
