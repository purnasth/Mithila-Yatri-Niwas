  ...
  return (
    <>
      <div
        ...
        className={`relative min-h-screen bg-[url('/src/assets/HistoryTemple.jpg')] bg-logo-bg bg-cover bg-top bg-fixed`}
      >
        {/* <div className="absolute bg-black/40 inset-0 z-0" /> */}
        <section className="z-10 text-custom-black text-center">
          <div className="text-center mb-12 container max-w-7xl mx-auto space-y-4">
