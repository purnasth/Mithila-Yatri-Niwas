        ...
        <div class="example-code">
            <form action="" class="col-md-12 center-margin" id="articles_frm">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-20">
                        <input placeholder="Google Embeded link" class="col-md-6 validate[required,length[0,200]]" type="text"
                               name="embed_link" id="embed_link"
                               value="<?php echo !empty($articlesInfo->embed_link) ? $articlesInfo->embed_link : ""; ?>">
                    </div>
                </div>
                <!-- <div class="form-row">
                    <div class="form-label col-md-2">
