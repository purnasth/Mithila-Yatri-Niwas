...
if (isset($_GET['page']) && $_GET['page'] == "package" && isset($_GET['mode']) && $_GET['mode'] == "packageImageList"):
    ...
    <form action="" class="col-md-12 center-margin" method="post" id="packgallery_frm">
        <div class="row">
        ...
        $(document).ready(function () {
            $('#users_upload').uploadify({
                ...
                'formData': {
                    ...
                    targetFolder: 'images/package/packgalleryimages/',
                    thumb_width: 200,
                    thumb_height: 200
                },
                'method': 'post',
                ...
                'onUploadSuccess': function (file, data, response) {
                    ...
                    var filename = data;
                    $.post('<?php echo BASE_URL;?>apanel/package/uploaded_gallery_image.php', {imagefile: filename}, function (msg) {
    ...
    <?php
    clearImages("tbl_package_images", "package/packgalleryimages");
    clearImages("tbl_package_images", "package/packgalleryimages/thumbnails");
...
//$newrecRow = ($ic++%4==0)?'</div><div class="row">':'';
                ...
                <span class="float-left"><?php
                    $filesize = filesize(SITE_ROOT . "images/package/packgalleryimages/" . $galleryRow->image);
                    echo 'Size : ' . getFileFormattedSize($filesize);
                    ?>
                </span>
                            <a class="btn small float-right" href="javascript:void(0);"
                               onclick="deletepackimage(<?php echo $galleryRow->id; ?>);">
                        ...
                        <img src="<?php echo IMAGE_PATH . 'package/packgalleryimages/thumbnails/' . $galleryRow->image; ?>"
                             style="width:100%"/>
                        <div class="button-group" data-toggle="buttons">
